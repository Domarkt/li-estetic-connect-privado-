...
const PAGE_TITLE: Record<string, { title: string; sub: string }> = {
  ...
  contabilidad: { title: 'Contabilidad', sub: 'Libro, movimientos, cuadres y reportes contables (DGII 606/607, ITBIS)' },
  ...
  auditoria: { title: 'Auditoría de sesiones', sub: 'Diligenciamiento de bitácoras y combos por estética y esteticista' },
