...
export interface SystemUser { id: string; name: string; email: string; role: string; roleKey: Role; branch: string; branchId: string | null; avatarColor: string; active: boolean; protected?: boolean; canManageCatalog?: boolean; atiendeCitas?: boolean; allowedModules?: CoordinatorModule[] }
